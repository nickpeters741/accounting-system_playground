...
$create_sale = mysqli_query($connection,"INSERT INTO kp_po(po_id,sup_id,user_id,amount,po_date,cf_bal,tax_by,tax_type,vatable,vat,tax_perc,refno)  VALUES('$po_id','$sup_id','$user_id','$total','$day','$bal','$tax','$tax','$vatable','$vatt','$perc','$refno')");
if (!$create_sale) {
