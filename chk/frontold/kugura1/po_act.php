...
$create_sale = mysqli_query($connection,"INSERT INTO kp_po(po_id,sup_id,user_id,amount,day,cf_bal,tax_by,tax_type,vatable,vat,tax_perc,refno)  VALUES('$lpo_id','$cust_id','$user_id','$total','$day','$bal','$tax','$tax','$vatable','$vatt','$perc','$refno')");
if (!$create_sale) {
	...
	logs($action,"../../");
    $clear_sale_status = mysqli_query($connection,"DELETE FROM kp_po_status  WHERE po_id='$lpo_id'") or die("Error"); 
      ?>
     <script type="text/javascript">
         window.location = "print_po.php";
      </script>
