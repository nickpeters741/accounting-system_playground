...
// $get_details = mysqli_query($connection,"SELECT * FROM kp_grn WHERE grn_id='$grn_id'") or die("Could not get the user permissions");
// $row=mysqli_fetch_assoc($get_details);
// $grn_id = $row['grn_id']; 
...
<head>
  ...
  <!-- <link href="../../assets/css/default/googleapi.css" rel="stylesheet" />  -->
