...
<div id="content" class="content"> 
  ...
  <div class="panel  paper-cut"  style="margin-left: 8px; width: 60%;" >
    <div class="row" style="padding-top: 5px;">
      ...
      <div class="col-md-2 col-xs-2">
        <input id="qty" type="" placeholder="Qty"  class="form-control form-control-xs">
      </div>
      <div class="col-md-2"> 
  ...
  <div class="panel  paper-cut"   style="margin-left: 10px; width: 38%;" >
      <div class="row" style="margin: 2px; padding: 1px 1px;"> 
        <div class="col-md-2 text-center" style="height: 40px; padding: 1px; border-radius: 10px; border-right: 1px solid #eee;">
          <div class="col-md-12">
            <a  data-toggle="modal"data-target="#modal" id="hold" class="btn btn-sm btn-warning"><h6>HOLD</h6></a>
          </div>
        </div>
        <div class="col-md-2 text-center" style="height: 40px; padding: 1px; border-right: 1px solid #eee;">
        ...
        <div class="row" id="d33"  style="margin: 2px; padding: 5px; color: white;">
        ...
        <div class="row" style="margin: 5px 5px; border: 1px solid #d9e0e7; padding: 5px;">
          ...
          <div class="form-group  col-md-8" style="display:none;" id="beb">
            <div class="input-group">
              <div class="input-group-prepend">
                <a data-toggle="modal" class="btn btn-warning" data-target="#modal" id="beba_staff" onclick="$('#load').html('');"><i class='fa fa-lg fa-plus' ></i></a> 
              </div>
        ...
        <div class="panel-body" style="margin-top: 10px;">
          ...
          <a data-toggle="modal" data-target="#modal" id="cancel_btn" class="btn btn-xs btn-danger pull-right"  onclick="$('#load').html('');"> CANCEL</a>
        </div> 
        </div>  
  </div>
</div>
