...
?>  
<div class="col-md-3" >
    <button class="btn btn-xs btn-primary">BASE&nbsp; <?php echo $base_price; ?>  </button>
</div> 
<div class="col-md-3" >
    <a data-toggle="modal" data-target="#modal" id="btn-price" onclick="price_adj(<?php echo $nm; ?>)" class="btn  btn-xs btn-primary">PRICE&nbsp; <?php echo $sprice; ?> 
    </a>
</div> 
<div class="col-md-2">
