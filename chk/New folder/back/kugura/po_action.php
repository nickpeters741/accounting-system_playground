...
if (empty($item_id) OR $item_id==0) {
	...
	if(mysqli_num_rows($results) < 1) {
		$create = mysqli_query($connection,"INSERT INTO kp_po_items(po_id,item_id,qty,price,total) VALUES('$po_id','$item_id','$quantity','$price','$amount')") or die(mysqli_error($connection));
		if (!$create) {
