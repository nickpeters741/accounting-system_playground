		...
		<div id="content" class="content">
			...
			<div class="row">
               ...
               <div class="pull-right">
                <Button href="#bank-modal" class="btn btn-sm btn-lime pull-right" data-toggle="modal" id="bank-add" ><i class="fa fa-plus"></i> &nbsp;NEW BANK</Button> &nbsp; &nbsp; &nbsp; &nbsp;
						...
						<div class="panel-body">
							 <?php
                  $get_category = mysqli_query($connection,"SELECT * FROM kp_banks WHERE del_status=1") or die("Could not get any items");
