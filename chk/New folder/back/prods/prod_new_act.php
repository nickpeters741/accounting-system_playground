...
if(empty($errorMSG)){
	...
	$field_values = array("stock_code","name","cat_id","sub_id","bprice","base_price","dprice","wprice","sprice","uom","tax_id","pcs","bulk","break_item");
	$result=array_merge( $field_values);
	 
	$data_values = array("'".$code."'","'".$name."'","'".$cat_id."'","'".$sub_id."'","'".$bprice."'","'".$base_price."'","'".$dprice."'","'".$wprice."'","'".$sprice."'","'".$uom."'","'".$tax_id."'","'".$pcs."'","'".$bulk."'","'".$break_pcs."'");
	$result2=array_merge( $data_values);

	if (Insertdata("kp_items", $result, $result2)) {
