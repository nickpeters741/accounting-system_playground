...
<bod  onload="setTimeout(function () { close(); }, 1000); window.print()"y>  
      ...
      <div class="p-order">
        ...
        <div class="inv-header" style="border-top:  2px solid #753f91; ">
          ...
          <div style=" border: green; width: 50%; float: right;">  
            <h1 style=" text-align: left; margin: 0px 0px 0px 0px;"><u><?php if($type==1){ echo "RECEIPT";}else{ echo "INVOICE";} ?></u> </h1>
            ...
            <div class="col-md-4" style="background-color: #753f91;width: 30%; float: right;">
              <table class="table">
                <thead style="background-color:#753f91; ">
                  <tr>
                    <th class="pull-left"><?php if($type==1){ echo "RECEIPT";}else{ echo "INVOICE";} ?> No: </th>
                    <th class="pull-right"><?php echo $sale_id; ?> </th>
                  </tr>
                  <tr>
                    <th class="pull-left"><?php if($type==1){ echo "RECEIPT";}else{ echo "INVOICE";} ?> Date: </th>
                    <th class="pull-right"><?php echo date("d-M-Y", strtotime($ord_date)); ?> </th>
                  </tr>
                <!--   <tr>
