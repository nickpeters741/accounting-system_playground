...
$create_sale = mysqli_query($connection,"INSERT INTO kp_sales(sale_id,cust_id,user_id,sale_amount,disc,total_amount,type,day,mktr,sale_bal,cf_bal,tax_type,vatable,vat)  VALUES('$sale_id','$cust_id','$user_id','$ord_total','$disc','$ord_total','$type','$day','$mkt','$ord_total','$cust_bal','$tax','$vatable','$vatt')")  ;//or die(mysqli_error($connection));
