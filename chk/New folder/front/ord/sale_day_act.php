...
<?php
	...
	$update = mysqli_query($connection,"UPDATE kp_sale_status SET day='$day' WHERE sale_id='$sale_id'") or die("Could not update");
	$update = mysqli_query($connection,"UPDATE kp_thesion SET day='$day' WHERE user_id='$user_id'") or die("Could not update");
	if (!$update) {
	?>
	<script type="text/javascript">
		$.gritter.add({
