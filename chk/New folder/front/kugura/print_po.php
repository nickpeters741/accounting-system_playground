    ...
    <div id="contents" class="contents">
      <div class="p-order">
        ...
        <div class="inv-header" style="border-top:  2px solid #753f91; ">
          ...
          <div style=" border-right: green; width: 50%; float: left;"> 
            <h2 class="pull-right" style=" text-align: right; font-size: 16px; margin:1px;"><u>PURCHASE ORDER</u> </h2>
            <h2 class="pull-right" style=" text-align: right; font-size: 16px; margin:1px;"> <?php echo $gen['company_name']; ?> </h2> 
          ...
          <div style=" border-right: green; width: 60%; float: left;">
            ...
            <div class="col-md-4" style=" width: 30%; float: right; padding:5px 1px">
              <table class="table">
                <tbody >
                  <tr>
                    <td class="pull-left">PO No: </td>
                    <td class="pull-right"><?php echo $po_id; ?> </td>
                  </tr>
                  <tr>
                    <td class="pull-left">PO Date: </td>
                    <td class="pull-right"><?php echo $po_date; ?> </td>
                  </tr>
                  <!-- <tr>
