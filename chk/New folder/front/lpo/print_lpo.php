    ...
    <div id="contents" class="contents">
      <div class="p-order">
       ...
       <!--  <div class="inv-header" style="border-top:  2px solid #753f91; ">
          ...
          <div style=" border-right: green; width: 50%; float: left;"> 
            <h2 class="pull-right" style=" text-align: right; font-size: 16px; margin:1px;"><u>LOCAL PURCHASE OORDER</u> </h2> <br>
            <address style="margin-top: 1px; text-align: right;">
              <?php echo $gen['company_name']; ?><br>
          ...
          <div style=" border: 1px solid #000; width: 50%;padding: 5px; float: left; margin-bottom: 15px;">
            ...
            <div class="col-md-4" style=" width: 30%; float: right; padding:5px 1px">
              <table class="table">
                <tbody >
                  <tr>
                    <td class="pull-left">Customer Ref No: </td>
                    <td class="pull-right"><?php echo $refno; ?> </td>
                  </tr>
                  <tr>
                    <td class="pull-left">LPO No: </td>
                    <td class="pull-right"><?php echo $lpo_id; ?> </td>
                  </tr>
                  <tr>
                    <td class="pull-left">LPO Date: </td>
                    <td class="pull-right"><?php echo $day; ?> </td>
                  </tr> 
                </tbody>
              </table>       
            </div> 
