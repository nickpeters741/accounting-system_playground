...
<?php
	...
	$update = mysqli_query($connection,"UPDATE kp_sale_status SET cust_id='$cust_id' WHERE sale_id='$sale_id'") or die("Could not update");
	...
	?>
	<script type="text/javascript">
		$("#custo").text('<?php echo get_cust($cust_id); ?>');
		var hulla = new hullabaloo();
