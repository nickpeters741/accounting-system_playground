...
$create_sale = mysqli_query($connection,"INSERT INTO kp_lpo(lpo_id,cust_id,user_id,amount,day,cf_bal,tax_type,vatable,vat,tax_perc,refno)  VALUES('$lpo_id','$cust_id','$user_id','$total','$day','$bal','$tax','$vatable','$vatt','$perc','$refno')");
