...
<!-- begin #content -->
		<div id="content" class="content">
				...
				<div class="col-md-11">
					<div class="panel panel-purple" data-sortable-id="index-1">
						<div class="panel-heading">
							...
							<h3 class="panel-title" style="color:white;">GOOD RECEIVED NOTES LIST</h3>
						</div>
			...
			<?php
                        ...
                        ?>
						<?php
						$pending_orders = mysqli_query($connection,"SELECT * FROM kp_grn") or die("Could not fetch the purchase orders");
                      ...
                      <td><?php echo get_sup($sup_id); ?></td>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu pull-right" style="background-color: purple;">
                            ...
                            <?php
                           // } ?>
                            <li><a href="grn_print.php?id=<?php echo $po_id; ?>">Re-print</a></li>
                            <li><a data-toggle="modal" data-target="#modal" data-id="<?php echo $grn_id; ?>" id="view"  >View Order</a></li> 
                          </ul>
                        </div>
                      </td>
                    </tr>
