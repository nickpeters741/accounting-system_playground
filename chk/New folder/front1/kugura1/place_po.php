...
$create_po = mysqli_query($connection,"INSERT INTO kp_po(po_id,sup_id,ord_user,ord_date,amount,disc,tax_type,tax_perc,vatable,vat) VALUES('$po_id','$sup_id','$user_id',CURRENT_DATE,'$tt','$disc','$tax_type','$perc','$vatable','$vatt')") or die(mysqli_error($connection));
if ($create_po) {
