...
<div class="modal-content"> 
  <div class="modal-body">      
    ...
    <div class="table-responsive">
      ...
      <thead>
          <tr>
            <th colspan="3" style="font-size: 19px;"><b><?php echo $day;?>  PURCHASES REPORT</b></th>
          </tr>
          <tr>
            <th>ITEM:</th> 
              <th>QTY</th>   
      ...
      <tbody>
              <?php 
        $sum=0;
         $sales = mysqli_query($connection,"SELECT kp_po.ord_date,item_id,SUM(qty) as qty,SUM(total) as total FROM kp_po_items INNER JOIN kp_po on kp_po.po_id=kp_po_items.po_id  WHERE  kp_po.ord_date='$day'");
