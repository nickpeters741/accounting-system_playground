...
.qty{  
  ...
  padding: 6px 12px;
      ...
      <table class="table" id="users" >
        ...
        <tbody>
          <?php
            $get_order = "SELECT * FROM kp_sale_items WHERE  sale_id='$sale_id' ";
            ...
            <tr style="color: #373a3c;" id="row<?php echo $item_id; ?>">
              <td><?php echo get_item($item_id)." (".uom_name($item_id,$uom_id).")"; ?></td>  
              <td>
            ...
            <tfooter class="table-inverse">
              <tr style="color: #373a3c; ">
                ...
                <th style="font-size: 20px; font-weight: 600px;">
                  <?php
