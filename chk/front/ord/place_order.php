			...
			//echo "OK 3 BANK UPDATED <BR>";
	 		if (insert_payments()) {
				...
				foreach($garr as $c) { 
	 			...
	 			$create_sale = mysqli_query($connection,"INSERT IGNORE INTO kp_sales(sale_id,cust_id,user_id,sale_amount,disc,total_amount,type,pay_status,day,delivery,mktr,refno,cf_bal,tax_type,vatable,vat,shop) VALUES('$sale_id','$cust_id','$user_id','$order_total','$disc','$sale_amount','$sale_type',1,'$day','$damount','$mkt',0,'$cust_bal','$tax','$vatable','$vatt','$shop')") or die(mysqli_error($connection));
	 			if ($create_sale) {
