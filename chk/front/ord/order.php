  ...
  <div class="panel  paper-cut"   style="margin-left: 10px; width: 38%;" >
    ...
    <div class="panel-body" >
      ...
      <div class="amount-block row">
          ...
          <ul class="list-group">
            <li class="list-group-item global-discount-group" style="height: auto;"> 
              <div class="row">
                <label class=" col-md-12" style="color: #6FD64B; font-size: 14px;">ADD TAX:</label> 
        ...
        <div class="total amount col-md-6" style="text-align: center; color: #6FD64B; font-size: 14px;">
        ...
        <div class="col-md-12 m-t-5">
          <ul class="list-group">
            <li class="list-group-item global-discount-group"> 
              <div class="pull-left" style="text-align: center; color: #6FD64B; font-size: 14px;"><b>VATABLE:</b>&nbsp;<b id="vatable"></b></div>
              <div class="pull-right" style="text-align: center; color: #6FD64B; font-size: 14px;"><b>VAT:</b>&nbsp;<b id="vatt">0</b></div> 
            </li>
            <li class="list-group-item global-discount-group"> 
              <div class="pull-left" style="text-align: center; color: #6FD64B; font-size: 14px;"><b>TOTAL:</b>&nbsp;<b id="tt"></b></div> 
            </li>
          </ul> 
        </div> 
      </div>
