...
<div class="modal-content" style="width: 800px;">
  ...
  <div class="modal-body">
    ...
    <div class="row">  
     ...
     <div class="col-md-4"><b style="font-size: 14px; color: blue;">SALES PERSON:  <?php echo get_user($mkt); ?></b></div>
     <div class="col-md-4"><b style="font-size: 14px; color: blue;">SALE DATE:  <?php echo $day; ?></b></div> 
     <div class="col-md-4"><b style="font-size: 14px; color: blue;">LPO NO :  <?php echo $lporefno; ?></b></div>
     <div class="col-md-4"><b style="font-size: 14px; color: blue;">DELIVERY ID :  <?php echo $delino; ?></b></div> 
    </div>
...
function complete() {  
  var lporefno='<?php echo $lporefno ?>';
  var delino='<?php echo $delino ?>';
  ...
  $.post("credit_action.php", { lporefno:lporefno,delino:delino,deli:deli,reg:reg,means:means,disc:disc,beba:beba,vatable:vatable,vatt:vatt,tax:tax },
    function(data){ 
