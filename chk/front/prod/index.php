        ...
        <div class="panel panel-inverse" data-sortable-id="index-1" style="margin-top: 10px;">
          <div class="panel-heading"> 
            <div class="pull-right">
              <Button href="#modal" class="btn btn-sm btn-lime pull-right" data-toggle="modal" id="new-cust" ><i class="fa fa-plus"></i> &nbsp;Add Produce</Button> &nbsp; &nbsp; &nbsp; &nbsp;
              <Button href="#modal" class="btn btn-sm btn-lime pull-center" data-toggle="modal" id="new-cust" ><i class="fa fa-check"></i> &nbsp;Re- Stock</Button> &nbsp; &nbsp; &nbsp; &nbsp;
            </div>
