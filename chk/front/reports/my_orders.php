              ...
              <td class="with-btn-group" nowrap>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                  ...
                                  if ($sa['type']==1) {
                                    ?>
                                    <li style="color: white;"><a data-toggle="modal" data-target="#modal" data-id="<?php echo $sale_id; ?>" data-id2="<?php echo $sa['type']; ?>" id="re-print">REPRINT</a></li>
                                    <?php
                                    }elseif ($sa['type']==2) {
                                      ?>
                                    <li style="color: white;"><a data-toggle="modal" data-target="#modal" data-id="<?php echo $sale_id; ?>" data-id2="<?php echo $sa['type']; ?>" id="re-print">REPRINT</a></li>
                                  ...
                                  <li style="color: white;"><a data-toggle="modal" data-target="#modal" data-id="<?php echo $sale_id; ?>" id="view" onclick="view(<?php echo $sale_id; ?>);">VIEW</a></li> <!-- -->
