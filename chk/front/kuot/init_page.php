...
<body>
    ...
    <!-- begin #menu -->
		...
		<div id="contents" class="contents">
            ...
            <div class="panel panel-purple">
              <div class="panel-heading">  
                <div class="pull-right">
                  ...
                  <a data-toggle="modal" data-target="#modal" name="new-qt" id="new-qt" class="btn btn-lime btn-xs pull-right"  style="color: #fff;">NEW QUOTE</a>
                </div>
                <h2 class="panel-title" style="color: #fff; font-weight: bold;">ONGOING QUOTATIONS</h2>
              </div>
              ...
              <tbody>
                <?php
                $get_items = mysqli_query($connection,"SELECT * FROM kp_qt_status") or die(mysqli_error($connection));
                while ($oow = mysqli_fetch_assoc($get_items)) { 
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      ?>
                      <a href="init_qt.php?id=<?php echo $qt_id; ?>&st=CONT" style="margin-left: 10px;" type="button"  name="filter" class="btn btn-warning btn-xs">CONTINUE</a>  
                      <?php
                      } 
                      ?>
                    </td>
          ...
          <div class="panel panel-purple">
            <div class="panel-heading"> 
              <h2 class="panel-title" style="color: #fff; font-weight: bold;">TODAY'S QUOTATIONS</h2>
            </div>
            <!-- begin panel-body -->
            <div class="panel-body ">
              <table id="data-table-combine" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php
                  $pending_orders = mysqli_query($connection,"SELECT * FROM kp_qt WHERE day=CURRENT_DATE") or die("Could not fetch today's quotes");
                      ...
                      <td class="with-btn-group" nowrap>
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu pull-right" style="background-color: purple;">
                            ...
                            <li><a href="qt_print.php?id=<?php echo $id; ?>">Re-print</a></li>
