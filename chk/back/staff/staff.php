...
$action="LOADED|-|-|ACTIVE STAFF PAGE";
logs($action,"../../");
$no=0;
 $folder="back/staff/";
  thesion_page($folder);
		...
		<div id="content" class="content">
			...
			<div class="row">
               ...
               <div class="pull-right">
                <Button href="#staff-modal" class="btn btn-sm btn-lime pull-right" data-toggle="modal" id="staff-add" ><i class="fa fa-plus"></i> &nbsp;ADD STAFF</Button> &nbsp; &nbsp; &nbsp; &nbsp;
          
               </div>
              
							<h4 class="panel-title">ACTIVE STAFF LIST</h4>
             	</div>
						<div class="panel-body">
							 ...
							 <?php
                  $get_customers = mysqli_query($connection,"SELECT * FROM kp_staff WHERE staff_del_status=2") or die("Could not get any staff");
                  if (mysqli_num_rows($get_customers) < 1) {
                    echo "There are no registered staff in the database";
                  }else{
                ?>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="with-btn-group" nowrap>
                            <div class="btn-group">
                                <a href="#" class="btn btn-warning btn-xs width-60">Actions</a>
                                ...
                                <ul class="dropdown-menu pull-left">
                                  <li><a data-toggle="modal" data-target="#staff-modal" data-id="<?php echo $row['staff_id']; ?>" id="staff_edit">Edit Staff</a></li>
                                   <li><a data-toggle="modal" data-target="#staff-modal" data-id="<?php echo $row['staff_id']; ?>" id="change_nok">Edit N.O.K Details</a></li>
                                  <!-- <li><a data-toggle="modal" data-target="#prods-modal" data-id="<?php echo $row["item_id"]; ?>" id="price-adj">Make User</a></li>-->
                                  <li><a data-toggle="modal" data-target="#staff-modal" data-id="<?php echo $row["staff_id"]; ?>" id="nok">N.O.K Details</a></li> 
                                </ul>
                            </div>
                        </td>
                        </tr>
