  ...
  <!-- end #sidebar -->
		...
		<div id="content" class="content">
			...
			<div class="row">
              ...
              <h4 class="panel-title">ARCHIVED USERS LIST</h4>
            </div>
						<div class="panel-body">
							 <?php
                  $get_users = mysqli_query($connection,"SELECT * FROM kp_users WHERE user_work_status=1") or die("Could not get any users");
                  if (mysqli_num_rows($get_users) < 1) {
                    echo "There are no archived users in the database";
                  }else{
                ?>
